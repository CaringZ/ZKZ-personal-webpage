...
export function ThreeDShowcase({ items, onItemClick }: ThreeDShowcaseProps) {
  ...
  return (
    <div className="relative flex flex-1 min-h-0 flex-col items-center justify-center overflow-hidden bg-[radial-gradient(circle_at_top,#1f2937_0%,#050505_55%)] px-4 sm:px-8 lg:px-0">
      {!hasItems ? (
        <div className="rounded-3xl border border-white/10 bg-white/5 px-10 py-12 text-center text-white/70 backdrop-blur">
          3D 作品即将上线，敬请期待。
        </div>
      ) : (
        <div className="relative flex h-full w-full max-w-[min(92vw,1280px)] flex-col items-center justify-center">
          <div className="relative w-full">
            <div className="relative h-[480px] w-full sm:h-[560px] md:h-[640px] lg:h-[700px]">
              <div className="relative flex h-full w-full items-center justify-center">
                {items.map((item, index) => {
                  ...
                  return (
                    ...
                    >
                      <div className="relative h-[480px] w-[320px] overflow-hidden rounded-[30px] border border-white/12 bg-black/65 shadow-[0_40px_130px_rgba(17,24,39,0.5)] backdrop-blur-lg sm:h-[520px] sm:w-[360px] md:h-[580px] md:w-[420px] lg:h-[620px] lg:w-[460px]">
